...
newline_templates = [
    (
        "Please call me tomorrow. I have something to say.",
    ...
    (
        "I am working on a new project. It is very hard.",
        "I am working on a new project.\nIt is very hard.",
    ),
    (
        "She lives in a small town. You will like it.",
...
plurality_templates = [
    ...
    (
        "There are several student in the room.",
        "There are several students in the room.",
        "There are several students in the room.",
    ),
    (
        "They visited many country last year.",
        "They visited many countries last year.",
        "They visited many countries last year.",
    ),
    (
        "All my friend are coming tonight.",
        "All my friends are coming tonight.",
        "All my friends are coming tonight.",
    ),
    (
        "We need two box of matches.",
        "We need two boxes of matches.",
        "We need two boxes of matches.",
    ),
    (
        "He has many book in his library.",
        "He has many books in his library.",
        "He has many books in his library.",
    ),
    (
        "I saw three child playing outside.",
        "I saw three children playing outside.",
        "I saw three children playing outside.",
    ),
    ...
    (
        "How many ticket did you buy?",
        "How many tickets did you buy?",
        "How many tickets did you buy?",
    ),
    (
        "We need more desk in the office.",
        "We need more desks in the office.",
        "We need more desks in the office.",
    ),
    (
        "The bird are singing in the tree.",
    ...
    (
        "He has two uncle and three aunt.",
        "He has two uncles and three aunts.",
        "He has two uncles and three aunts.",
    ),
