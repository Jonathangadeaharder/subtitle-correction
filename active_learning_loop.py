...
FALLBACK_CONFUSIONS = [
    ...
    ("its", "it's"), ("it's", "its"), ("to", "too"), ("too", "to"),
    ("were", "where"), ("where", "were"), ("then", "than"), ("than", "then"),
    ("heard", "hard"), ("knew", "new"), ("seen", "scene"), ("here", "hear"),
    ("affect", "effect"), ("loose", "lose"), ("advice", "advise"),
    ("Leakey", "Leekie"), ("Delfin", "Delphine"), ("Katya", "Katja"),
...
def generate_targeted_batch(confusions, count, seed):
    ...
    for _ in range(count):
        ...
        filler = rng.choice(["something", "nothing", "everything", "anyone", "everyone", "today", "tomorrow"])
